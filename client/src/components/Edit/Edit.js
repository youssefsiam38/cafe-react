...
const Edit = (props) => {
    ...
    useEffect(() => {
        if (!props.data.loading) {
            setState({
                name: props.data.menuItem.name,
                type: props.data.menuItem.type,
                price: props.data.menuItem.price,
                description: props.data.menuItem.description,
                photoURL: props.data.menuItem.photoURL
            })
        }
    }, [props])
